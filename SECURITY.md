...
# Security Policy for Astra

## Supported Versions

The Astra project provides security updates for the following versions:
...
If you discover a security vulnerability in Astra, we encourage responsible disclosure. To report a vulnerability:
...
We appreciate the security community's efforts in helping us maintain Astra’s safety and integrity.

## Security Practices

Astra follows industry best practices for security to ensure safe transactions and protect user data:

### 1. **Authentication and Authorization**

- Astra uses secure methods for user authentication, including strong password hashing (e.g., bcrypt).
...
Contributors can help enhance Astra's security by following these practices:
...
Thank you for helping us make Astra secure for our users and the community!
